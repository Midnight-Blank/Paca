...
def main_menu(): #Main menu Screen
    ...
    while True:
        ...
        Menu_Mouse_Pos = pygame.mouse.get_pos()#get position of mouse

        Menu_Text = get_font(100).render('Main Menu', True, '#b68f40')#display main menu on screen
        ...
        screen.blit(Menu_Text, Menu_Rect)#Displays the menu text and images displayed with it
...
class Ghost:
    #ghosts coordinates and functions involved in operation
    ...
    def check_collisions(self):
        #check collisions of ghosts with walls
        num1 = ((HEIGHT - 50) // 32)
        num2 = (WIDTH // 30)
        num3 = 15
    ...
    def move_clyde(self):
        # clyde movement / whereever tracks player best
        if self.direction == 0:
...
def check_position(centerx, centery):
    #checks position to render to the board
...
def get_targets(blink_x, blink_y, ink_x, ink_y, pink_x, pink_y, clyd_x, clyd_y):
    #movements for ghosts and when powerup is in play
    if player_x < 450:
        runaway_x = 900
    else:
        runaway_x = 0
...
while run:
    ...
    if powerup and player_circle.colliderect(blinky.rect) and eaten_ghost[0] and not blinky.dead:
        #player collides with position of powerup causing it to switch mode of ghosts
        if lives > 0:
            powerup = False
            power_counter = 0
            lives -= 1
